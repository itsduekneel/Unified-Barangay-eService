    ...
    try {
      ...
      if (mounted) {
        final list = (data as List)
            .map<_Service>(
              (m) => _Service.fromMap(Map<String, dynamic>.from(m as Map)),
            )
            .toList();
        setState(() {
          _services = list;
        ...
        Expanded(
          child: PageView(
            ...
            children: [
              ...
              _Page3Info(formKey: _personalFormKey, fieldStates: _fieldStates),
            ],
          ),
        ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const _InfoBox(
            message:
                'Pumili ng serbisyo bago mag-proceed sa schedule. '
              ...
              return GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: active
                          ? const Color(0xFF8B35E2)
                          : const Color(0xFFE7DDF3),
                      width: active ? 1.8 : 1.2,
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF8B35E2).withValues(alpha: 0.04),
                        blurRadius: 8,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const _InfoBox(
            message:
                'Pumili ng preferred date at oras ng iyong appointment. '
...
class _Page3Info extends StatelessWidget {
  ...
  const _Page3Info({required this.formKey, required this.fieldStates});
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const _InfoBox(
            message:
                'Ilagay ang iyong personal na impormasyon para makontak '
