  ...
  Future<void> _loadAttendance() async {
    ...
    try {
      ...
      final fetched = (res as List)
          .map((r) => _WorkerAttendance.fromMap(r))
          .toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // ── Date selector
          _DateHeader(selectedDate: _selectedDate, onPickDate: _pickDate),
...
class _WorkerAttendance {
  ...
  factory _WorkerAttendance.fromMap(Map<String, dynamic> m) =>
      _WorkerAttendance(
        id: m['id'] as String?,
