...
class _Task {
  ...
  String get formattedDueDate {
    ...
    try {
      return DateFormat('MMM dd, yyyy').format(DateTime.parse(dueDate!));
    } catch (_) {
      return dueDate!;
    }
  }
...
Color _avatarColor(String id) =>
    _kAvatarColors[id.hashCode.abs() % _kAvatarColors.length];
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        final myTasks = all
            .where((t) => t.assignedToId == _currentUserId)
            .toList();
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton.extended(
            ...
            onPressed: () =>
                Navigator.push(context, instantRoute(const _WorkloadPage())),
          ),
        );
      },
    );
        ...
        child: Row(
          children: [
            _ViewToggleBtn(
              ...
              count: myCount,
              active: _viewMode == 'my',
              onTap: () => setState(() => _viewMode = 'my'),
            ),
            _ViewToggleBtn(
              label: 'All Tasks',
              count: allCount,
              active: _viewMode == 'all',
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: active ? _kAccentBorder : Colors.transparent,
            ),
          ),
          child: Row(
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: task.isOverdue && task.status != 'done'
                ? _kRedBorder
                : _kBorder,
          ),
          boxShadow: [
            ...
            if (task.isOverdue && task.status != 'done')
              Container(
                ...
                decoration: const BoxDecoration(
                  ...
                  border: Border(
                    bottom: BorderSide(color: _kRedBorder, width: 0.5),
                  ),
                ),
                child: const Row(
                  children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: pCfg.border),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                        ...
                        ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            ...
                            valueColor: AlwaysStoppedAnimation(
                              task.progress == 100 ? _kGreen : _kAccent,
                            ),
                            minHeight: 5,
                          ),
                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                ...
                                size: 10,
                                color: task.isOverdue ? _kRed : _kText3,
                              ),
                              const SizedBox(width: 3),
                              Text(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: const LinearGradient(
                        colors: [Color(0xFF7C22E0), _kAccent],
                  ...
                  if (_workers.isEmpty)
                    ...
                    ...List.generate(
                      _workers.length,
                      (i) => _WorkerCard(worker: _workers[i]),
                    ),
                ],
              ),
            ),
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  shape: BoxShape.circle,
                  border: Border.all(color: acColor.withValues(alpha: 0.3)),
                ),
                child: Center(
                  child: Text(
                    worker.initials,
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    '${worker.doneCount}/${worker.taskCount} done',
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              _WorkerStat(
                '${worker.taskCount - worker.doneCount}',
                'Pending',
                _kOrange,
                _kOrangeBg,
                _kOrangeBorder,
...
class _TaskDetailPageState extends State<_TaskDetailPage> {
  ...
  void _toggleSubtask(int i, bool val) {
    setState(() {
      ...
      _progress = _subtasks.isEmpty
          ? _progress
          : ((done / _subtasks.length) * 100).round();
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: tsCfg.bg,
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(color: tsCfg.border),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
              ...
              child: Column(
                children: [
                  if (widget.task.assignedToName != null) ...[
                    _AssigneeRow(
                      name: widget.task.assignedToName!,
                      acColor: acColor,
                    ),
                    _DividerLine(),
                  ],
                ...
                children: [
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.w800,
                          color: _progress == 100 ? _kGreen : _kAccent,
                        ),
                      ),
                      Text(
                        'Completion',
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      backgroundColor: _kBorder,
                      valueColor: AlwaysStoppedAnimation(
                        _progress == 100 ? _kGreen : _kAccent,
                      ),
                      minHeight: 10,
                    ),
                  ),
                              ...
                              children: [
                                AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    shape: BoxShape.circle,
                                    border: Border.all(
                                      color: done ? _kGreen : _kGrayBorder,
                                      width: 1.5,
                                    ),
                                  ),
                                  child: done
  ...
  Future<void> _save() async {
    ...
    try {
      await _sb.from('tasks').insert({
        ...
        'assigned_to_name': _assignCtrl.text.trim().isEmpty
            ? null
          ...
          child: Column(
            ...
            children: [
              ...
              _AdminFormField(
                ...
                hint: 'e.g. Process Barangay Clearance…',
                required: true,
              ),
              const SizedBox(height: 12),
              _AdminFormField(
                ...
                hint: 'e.g. Documentation, Field Work…',
              ),
              const SizedBox(height: 12),
              _AdminFormField(
                label: 'Description',
                ...
                hint: 'Task details or instructions…',
                maxLines: 3,
              ),
              const SizedBox(height: 20),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: 13,
                            color: _dueDate == null ? _kText3 : _kText,
                          ),
                        ),
                      ),
                      if (_dueDate != null)
                  ...
                  child: const Center(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 5),
                        Text(
                          'No subtasks yet.\nTap "Add Subtask" to break this task down.',
