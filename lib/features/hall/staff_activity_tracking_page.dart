                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      height: 38,
                      decoration: BoxDecoration(
                        color: _attColor(a.status).withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(10),
                      ),
                      child: Icon(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _attColor(a.status).withValues(alpha: 0.4),
                        ),
                      ),
                      child: Text(
                        _attLabel(a.status),
                ...
                children: [
                  ...
                  if (todayStatus != null)
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _attColor(todayStatus).withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                          color: _attColor(todayStatus).withValues(alpha: 0.4),
                        ),
                      ),
                      child: Text(
