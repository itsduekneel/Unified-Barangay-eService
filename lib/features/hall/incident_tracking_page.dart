...
//     personal_info jsonb               -- [{label, value, required}]
//   );
// ─────────────────────────────────────────────────────────────────────────────
...
const _kCategories = [
  _Category('fire',          'Fire',              Icons.local_fire_department_rounded, Color(0xFFDC2626)),
  _Category('flood',         'Flood',             Icons.water_rounded,                 Color(0xFF1D4ED8)),
  _Category('crime',         'Crime / Security',  Icons.security_rounded,              Color(0xFF7C3AED)),
  _Category('medical',       'Medical Emergency', Icons.medical_services_rounded,      Color(0xFFE11D48)),
  _Category('disaster',      'Natural Disaster',  Icons.storm_rounded,                 Color(0xFF0891B2)),
  _Category('accident',      'Road Accident',     Icons.car_crash_rounded,             Color(0xFFEA580C)),
  ...
  _Category('environmental', 'Environmental',     Icons.eco_rounded,                   Color(0xFF15803D)),
...
_Category _catByKey(String key) =>
...
const _statusMap = {
  ...
  'investigating': _StatusCfg('Investigating', _kBlue,   _kBlueBg,   _kBlueBorder,   Icons.manage_search_rounded),
  'resolved':      _StatusCfg('Resolved',      _kGreen,  _kGreenBg,  _kGreenBorder,  Icons.check_circle_outline_rounded),
  'dismissed':     _StatusCfg('Dismissed',     _kGray,   _kGrayBg,   _kGrayBorder,   Icons.do_not_disturb_rounded),
};
...
const _severityMap = {
  'low':      _SeverityCfg('Low',      _kGreen,          _kGreenBg,          _kGreenBorder,          Icons.arrow_downward_rounded),
  'medium':   _SeverityCfg('Medium',   _kOrange,         _kOrangeBg,         _kOrangeBorder,         Icons.remove_rounded),
  'high':     _SeverityCfg('High',     _kRed,            _kRedBg,            _kRedBorder,            Icons.arrow_upward_rounded),
  'critical': _SeverityCfg('Critical', Color(0xFF7F1D1D), Color(0xFFFEE2E2), Color(0xFFFCA5A5),      Icons.priority_high_rounded),
};
...
class _InfoField {
  ...
  _InfoField({String label = '', String value = '', this.isRequired = false})
...
class _AdminIncidentPageState extends State<AdminIncidentPage>
  ...
  final _statusTabs = ['all', 'pending', 'investigating', 'resolved', 'dismissed'];
            ...
            actions: [
              Padding(
                ...
                child: _PillBtn(
                  ...
                  label: 'New',
                  onTap: () => Navigator.push(context, instantRoute(const _CreateIncidentPage())),
                ),
              ),
            ],
          ),
                ...
                child: snapshot.connectionState == ConnectionState.waiting && !snapshot.hasData
                  ...
                  itemBuilder: (_, i) => _IncidentCard(
                    ...
                    onTap: () => Navigator.push(
                      context,
                      instantRoute(_IncidentDetailPage(incident: filtered[i])),
                    ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          _StatPill('${counts['investigating']}', 'Active',   _kBlue,   _kBlueBg,   _kBlueBorder),
          const SizedBox(width: 8),
          _StatPill('${counts['resolved']}',      'Resolved', _kGreen,  _kGreenBg,  _kGreenBorder),
          const SizedBox(width: 8),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                cat.label,
                                style: TextStyle(
                                    fontSize: 9, fontWeight: FontWeight.w700, color: cat.color),
                              ),
                            ),
                            const SizedBox(width: 5),
                            Container(
                        ...
                        Row(
                          children: [
                            const Icon(Icons.person_outline_rounded, size: 11, color: _kText3),
                            const SizedBox(width: 3),
                            Expanded(
                              child: Text(
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(sCfg.label,
                                style: TextStyle(
                                    fontSize: 9, fontWeight: FontWeight.w800, color: sCfg.fg)),
                          ],
                        ),
                      ),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.crisis_alert_rounded, color: _kAccent, size: 30),
          ),
          const SizedBox(height: 14),
          const Text('No incident reports',
...
class _IncidentDetailPage extends StatefulWidget {
  final _Incident incident;
  const _IncidentDetailPage({super.key, required this.incident});
...
class _IncidentDetailPageState extends State<_IncidentDetailPage> {
  ...
  Future<void> _delete() async {
    final confirmed = await _confirm(context, 'Delete this report?', 'This action cannot be undone.');
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                        ...
                        Row(
                          children: [
                            ...
                            if (widget.incident.referenceNo != null) ...[
                              const SizedBox(width: 5),
                              Text(widget.incident.referenceNo!,
                                  style: const TextStyle(fontSize: 11, color: _kText3)),
                            ],
                          ],
                        ),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(sCfg.label,
                                style: TextStyle(
                                    fontSize: 10, fontWeight: FontWeight.w800, color: sCfg.fg)),
                          ],
                        ),
                      ),
                      const SizedBox(height: 5),
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 3),
                            Text('${sevCfg.label} Severity',
                                style: TextStyle(
                                    fontSize: 9, fontWeight: FontWeight.w700, color: sevCfg.fg)),
                          ],
                        ),
                      ),
                    ],
            ...
            _DetailCard(
              child: _DetailRow(
                  Icons.calendar_today_rounded, 'Filed', widget.incident.createdAt),
            ),
            ...
            _DetailCard(
              child: widget.incident.personalInfo.isNotEmpty
                  ? Column(
                children: [
                  for (int i = 0; i < widget.incident.personalInfo.length; i++) ...[
                    if (i > 0) _DividerLine(),
                ...
                child: Text('No reporter information provided.',
                    ...
                    if (isRequired)
                      Container(
                        ...
                        child: const Text('Required',
                            style: TextStyle(
                                fontSize: 9, color: _kRed, fontWeight: FontWeight.w700)),
                      ),
                  ],
                ),
                const SizedBox(height: 3),
...
class _CreateIncidentPageState extends State<_CreateIncidentPage> {
  ...
  // Only used when 'other' is selected
  ...
  Future<void> _save() async {
    ...
    // If "Other" is selected, the type field must be filled
    ...
    for (final f in _personalFields) {
      if (f.isRequired && f.valueCtrl.text.trim().isEmpty) {
        _snack('"${f.labelCtrl.text.isEmpty ? 'A required field' : f.labelCtrl.text}" cannot be empty.');
        return;
      }
    }
    ...
    bool _hasContent(_InfoField f) =>
        f.labelCtrl.text.trim().isNotEmpty || f.valueCtrl.text.trim().isNotEmpty;

    final infoList = _personalFields.where(_hasContent).map((f) => f.toMap()).toList();

    try {
      await _sb.from('incidents').insert({
        'incident_category': _selectedCategory,
        // Only send incident_type when 'other' is selected
        ...
        actions: [
          _saving
            ...
            child: SizedBox(
              ...
              : IconButton(
            icon: const Icon(Icons.check_rounded, color: _kAccent, size: 22),
            onPressed: _save,
          ),
        ],
      ),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  const Expanded(child: _SectionLabel(label: 'Incident Category')),
                  if (_selectedCategory == null)
                    Container(
                ...
                children: _kCategories.map((cat) {
                  ...
                  return GestureDetector(
                    onTap: () => setState(() {
                      ...
                      // Clear the type field when switching away from 'other'
                    ...
                    child: AnimatedContainer(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(cat.icon,
                              size: 15, color: active ? cat.color : _kText3),
                          const SizedBox(width: 6),
                          Flexible(
                            child: Text(
                              cat.label,
                  ...
                  return Expanded(
                    child: GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Column(
                          children: [
                            Icon(c.icon, size: 16, color: active ? c.fg : _kText3),
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(infoText,
                    style: const TextStyle(fontSize: 11, color: _kText2, height: 1.5)),
              ),
            ],
          ),
        ),
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  Text(emptyHint,
                      textAlign: TextAlign.center,
                      style: const TextStyle(fontSize: 11, color: _kText3, height: 1.6)),
                ],
              ),
            ),
          )
