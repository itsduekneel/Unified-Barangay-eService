...
class _RbacManagementPageState extends State<RbacManagementPage> {
  ...
  int get _totalUsers =>
      _roles.fold<int>(0, (s, r) => s + r.userCount);
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 10),
                  _StatCard(
                      value: '$_totalPermissions', label: 'Permissions'),
                ],
              ),
            ),
            ...
            Row(
              children: [
                Container(
                  ...
                  child:
                  Icon(role.icon, color: role.color, size: 18),
                ),
                const SizedBox(width: 10),
                Expanded(
                  child: Column(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Icon(Icons.close,
                      size: 15, color: Color(0xFF5F5E5A)),
                ),
              ),
            ],
          ),
            ...
            child: OutlinedButton.icon(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content:
                    Text('Edit permissions for ${role.name}'),
