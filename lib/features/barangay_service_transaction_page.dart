...
const _statusMap = {
  ...
  'processing': _StatusCfg('Processing', _kBlue,   _kBlueBg,   _kBlueBorder,   Icons.autorenew_rounded),
  'completed':  _StatusCfg('Completed',  _kGreen,  _kGreenBg,  _kGreenBorder,  Icons.check_circle_outline_rounded),
  'released':   _StatusCfg('Released',   _kTeal,   _kTealBg,   _kTealBorder,   Icons.move_to_inbox_rounded),
  'rejected':   _StatusCfg('Rejected',   _kRed,    _kRedBg,    _kRedBorder,    Icons.cancel_outlined),
};

_StatusCfg _sCfg(String s) => _statusMap[s] ?? _statusMap['pending']!;

const _kStatuses = ['pending', 'processing', 'completed', 'released', 'rejected'];
const _kStatusTabs = ['all', 'pending', 'processing', 'completed', 'released', 'rejected'];
const _kTabLabels  = ['All', 'Pending', 'Processing', 'Done', 'Released', 'Rejected'];
...
const _typeMap = {
  'clearance':    _TypeCfg('Clearance',    Icons.verified_outlined,          _kGreen,  _kGreenBg,  _kGreenBorder),
  'certificate':  _TypeCfg('Certificate',  Icons.workspace_premium_outlined,  _kBlue,   _kBlueBg,   _kBlueBorder),
  'permit':       _TypeCfg('Permit',       Icons.approval_outlined,           _kOrange, _kOrangeBg, _kOrangeBorder),
  'indigency':    _TypeCfg('Indigency',    Icons.volunteer_activism_outlined,  _kAccent, _kAccentBg, _kAccentBorder),
  'id':           _TypeCfg('Barangay ID',  Icons.badge_outlined,              _kTeal,   _kTealBg,   _kTealBorder),
  'complaint':    _TypeCfg('Complaint',    Icons.report_outlined,             _kRed,    _kRedBg,    _kRedBorder),
  'other':        _TypeCfg('Other',        Icons.help_outline_rounded,        _kGray,   _kGrayBg,   _kGrayBorder),
};

_TypeCfg _tCfg(String? t) => _typeMap[t] ?? _typeMap['other']!;

const _kTypes = ['clearance', 'certificate', 'permit', 'indigency', 'id', 'complaint', 'other'];
...
class _AdminServiceTransactionsPageState
  ...
  List<_Txn> _filter(List<_Txn> all) {
    return all.where((t) {
      ...
      final matchBrgy   = _selBarangayId == null || t.barangayId == _selBarangayId;
          ...
          builder: (context, brgySnap) {
            ...
            final counts = {
              for (final s in _kStatusTabs)
                s: s == 'all' ? all.length : all.where((t) => t.status == s).length,
            };
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon:
                          const Icon(Icons.search, color: _kText3, size: 18),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          _StatPill('${counts['processing']}', 'Processing', _kBlue,   _kBlueBg,   _kBlueBorder),
          const SizedBox(width: 8),
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      ...
                      color:
                      _tabCtrl.index == i ? _kAccent : _kText3,
                    ),
                  ),
                ),
              ],
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          runSpacing: 3,
                          children: [
                            _IconText(Icons.person_outline_rounded,
                                txn.residentName, 11),
                        ...
                        Wrap(
                          ...
                          children: [
                            if (txn.referenceNo != null)
                              _IconText(Icons.sell_outlined,
                                  txn.referenceNo!, 11),
                            if (txn.fee != null && txn.fee!.isNotEmpty)
                              _IconText(Icons.payments_outlined,
                                  txn.fee!, 11),
                          ],
                        ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(txn.createdAt,
                      style:
                      const TextStyle(fontSize: 9, color: _kText3)),
                  const SizedBox(width: 8),
                  _QuickAction(
                    label: 'View',
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String?>(
                  ...
                  hint: const Text('All Barangays',
                      style:
                      TextStyle(color: _kText3, fontSize: 13)),
                  icon: const Icon(
          ...
          children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      borderRadius: BorderRadius.circular(12),
                      border:
                      Border.all(color: type.color.withOpacity(0.28)),
                    ),
                    child: Icon(type.icon, color: type.color, size: 22),
                  ),
                  const SizedBox(width: 12),
            ...
            _DetailCard(
              child: Column(
                children: [
                  ...
                  _DividerLine(),
                  _DetailRow(Icons.location_city_outlined,  'Barangay',   t.barangayName ?? '—'),
                  _DividerLine(),
                  _DetailRow(Icons.payments_outlined,       'Fee',        t.fee?.isNotEmpty == true ? t.fee! : '—'),
                  _DividerLine(),
                  _DetailRow(Icons.info_outline_rounded,    'Purpose',    t.purpose?.isNotEmpty == true ? t.purpose! : '—'),
                  _DividerLine(),
                  _DetailRow(Icons.calendar_today_rounded,  'Filed',      t.createdAt),
                  if (t.completedAt != null) ...[
                    _DividerLine(),
                    _DetailRow(Icons.check_circle_outline_rounded, 'Completed', t.completedAt!),
                  ],
                  if (t.releasedAt != null) ...[
                    _DividerLine(),
                    _DetailRow(Icons.move_to_inbox_rounded, 'Released', t.releasedAt!),
                  ],
                ],
              ),
            ),
            ...
            _DetailCard(
              child: t.residentInfo.isNotEmpty
                ...
                child: Text('No resident information provided.',
                    style:
                    TextStyle(fontSize: 12, color: _kText3)),
              ),
            ),
            ...
            if (t.notes != null && t.notes!.isNotEmpty) ...[
              ...
              _DetailCard(
                child: Text(t.notes!,
                    style: const TextStyle(
                        fontSize: 13, color: _kText2, height: 1.6)),
              ),
            ],
