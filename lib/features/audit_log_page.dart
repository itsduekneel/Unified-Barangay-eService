      ...
      Padding(
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            child: Icon(
              Icons.tune_rounded,
              color: _showFilters ? Colors.white : kPrimary,
              size: 18,
            ),
          ),
        ),
        ...
        child: Row(
          children: [
            ...
            Icon(
              ...
              color: focused ? kPrimary : kTextMut,
              size: 20,
            ),
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 3),
                        Icon(Icons.close_rounded, size: 11, color: kPrimary700),
                      ],
                    ),
                  ),
                ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(date, style: const TextStyle(fontSize: 11, color: kTextMut)),
          const Spacer(),
          if (deleted > 0) ...[
            _Chip(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(16),
          splashColor: kPrimary.withValues(alpha: 0.05),
          highlightColor: kPrimary.withValues(alpha: 0.02),
        ...
        child: Column(
          ...
          children: [
            ...
            _SheetAction(
              ...
              onTap: () {
                Clipboard.setData(ClipboardData(text: entry.referenceId));
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('${entry.referenceId} copied to clipboard'),
