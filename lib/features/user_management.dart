                  ...
                  itemBuilder: (_, i) => _UserCard(
                    ...
                    onTap: () async {
                      final result = await Navigator.push(
                        context,
                        instantRoute(
                          UserDetailPage(user: filtered[i], avatarIndex: i),
                        ),
                      );
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: roleDropdownOpen ? _kAccent : _kBorder,
                ),
              ),
              child: Row(
                children: [
        ...
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: isSelected ? _kAccent.withValues(alpha: 0.15) : _kBg,
                borderRadius: BorderRadius.circular(8),
              ),
              child: Icon(
                role.icon,
