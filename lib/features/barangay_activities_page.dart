  ...
  factory _Activity.fromMap(Map<String, dynamic> m) {
    ...
    return _Activity(
      ...
      startDate: m['start_date'] != null
          ? DateTime.tryParse(m['start_date'])
          : null,
      ...
      targetParticipants: m['target_participants'] is int
          ? m['target_participants']
          : null,
      actualParticipants: m['actual_participants'] is int
...
class _BarangayActivitiesPageState extends State<BarangayActivitiesPage>
  ...
  List<_Activity> _filter(List<_Activity> all) {
    return all.where((a) {
      final matchStatus =
          _filterStatus == 'all' || a.status.dbKey == _filterStatus;
      final matchCat =
          _selCategory == _ActivityCategory.all || a.category == _selCategory;
      final matchBrgy =
          _selBarangayId == null || a.barangayId == _selBarangayId;
        ...
        return FutureBuilder<List<Map<String, dynamic>>>(
          ...
          builder: (context, brgySnap) {
            ...
            final counts = {
              'all': all.length,
              'upcoming': all
                  .where((a) => a.status == _ActivityStatus.upcoming)
                  .length,
              'ongoing': all
                  .where((a) => a.status == _ActivityStatus.ongoing)
                  .length,
              'completed': all
                  .where((a) => a.status == _ActivityStatus.completed)
                  .length,
              'cancelled': all
                  .where((a) => a.status == _ActivityStatus.cancelled)
                  .length,
            };
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (_, i) => _ActivityCard(
                              ...
                              onTap: () => Navigator.push(
                                context,
                                instantRoute(
                                  _ActivityDetailPage(activity: filtered[i]),
                                ),
                              ),
                            ),
                          ),
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: selected ? cat.color : _kBorder,
                  width: 1.2,
                ),
              ),
              child: Row(
                        ...
                        Wrap(
                          ...
                          children: [
                            if (activity.organizer != null &&
                                activity.organizer!.isNotEmpty)
                              _IconText(
                                Icons.person_outline_rounded,
                                activity.organizer!,
                                11,
                              ),
                            if (activity.barangayName != null &&
                                activity.barangayName!.isNotEmpty)
                              _IconText(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (a.barangayName != null &&
                            a.barangayName!.isNotEmpty)
                          Text(
                            a.barangayName!,
                            style: const TextStyle(
                              fontSize: 11,
              ...
              child: Column(
                children: [
                  _DetailRow(
                    Icons.people_outline_rounded,
                    'Target',
                    a.targetParticipants != null
                        ? '${a.targetParticipants}'
                        : '—',
                  ),
                  _DividerLine(),
                  _DetailRow(
                    ...
                    'Actual',
                    a.actualParticipants != null
                        ? '${a.actualParticipants}'
                        : '—',
                  ),
                  if (a.targetParticipants != null &&
                      a.actualParticipants != null) ...[
                    _DividerLine(),
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 10),
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                          color: active ? c.color : c.borderColor,
                        ),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(11),
              border: Border.all(
                color: hasDate ? _kAccent : _kBorder,
                width: hasDate ? 1.5 : 1,
              ),
            ),
            child: Row(
              children: [
                Icon(
                  Icons.calendar_today_rounded,
                  size: 14,
                  color: hasDate ? _kAccent : _kText3,
                ),
                const SizedBox(width: 8),
                Text(
                  hasDate
