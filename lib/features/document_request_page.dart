        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(
                IconData(doc.iconCode, fontFamily: 'MaterialIcons'),
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: _FormCard(
        ...
        subtitle: 'Fields specific to this document.',
        child: fields.isEmpty
            ...
            : Form(
                ...
                child: Column(
                  children: [
                    const _InfoBanner(
                      message: 'Answers will be pre-filled by staff.',
                    ),
                    ...fields.map((field) {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: _FormCard(
        ...
        subtitle: 'Review all details carefully.',
        child: Column(
          children: [
            _ReviewSection(
              title: 'Document',
        ...
        children: [
          Row(
            children: [
              ...
              if (required) const Text(' *', style: TextStyle(color: kDanger)),
            ],
          ),
...
class _InfoBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isWarning ? kWarnLight : kPrimaryLight,
        borderRadius: BorderRadius.circular(10),
        border: Border.all(color: c.withOpacity(0.2)),
      ),
      child: Row(
        children: [
          Icon(Icons.info_outline, color: c, size: 15),
...
class _EmptyFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Column(
        children: [
          Icon(Icons.check_circle_outline, color: kPrimary, size: 26),
          SizedBox(height: 10),
          Text(
