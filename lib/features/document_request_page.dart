  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Document Requests',
          style: TextStyle(color: kInk, fontWeight: FontWeight.w800, fontSize: 16),
        ),
        centerTitle: true,
        backgroundColor: kSurface,
        elevation: 0,
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const Text(
                      'Available Documents',
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: kInk),
                    ),
                    Text(
              ...
              if (vm.isLoading)
                ...
                _ErrorState(message: vm.errorMessage!, onRetry: vm.fetchDocuments)
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: kPrimary.withOpacity(0.06), blurRadius: 12, offset: const Offset(0, 4)),
        ],
      ),
      child: TextField(
        onChanged: onChanged,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  doc.amount == 0 ? 'FREE' : '₱${doc.amount.toStringAsFixed(2)}',
        ...
        child: Column(
          children: [
            Container(
              ...
              child: const Icon(Icons.folder_open_rounded, color: kPrimary, size: 30),
            ),
            const SizedBox(height: 14),
            const Text(
              'No documents found',
        ...
        child: Column(
          children: [
            Container(
              width: 56,
              height: 56,
              decoration: const BoxDecoration(color: kDangerBg, shape: BoxShape.circle),
              child: const Icon(Icons.wifi_off_rounded, color: kDanger, size: 26),
            ),
            const SizedBox(height: 12),
            Text(message, textAlign: TextAlign.center, style: const TextStyle(color: kDanger, fontSize: 13)),
            const SizedBox(height: 16),
            TextButton.icon(
              onPressed: onRetry,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: kBorder),
        boxShadow: [
          BoxShadow(color: kPrimary.withOpacity(0.07), blurRadius: 16, offset: const Offset(0, 3)),
        ],
      ),
      child: Row(
        children: [
          Container(
            width: 44,
            height: 44,
            decoration: BoxDecoration(color: kPrimaryBg, borderRadius: BorderRadius.circular(11)),
            child: Icon(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  document.title,
                  style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 14, color: kInk),
                ),
                const SizedBox(height: 4),
                Row(
                  children: [
                    const Text('Processing fee', style: TextStyle(fontSize: 11, color: kInk2)),
                    const SizedBox(width: 8),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                      decoration: BoxDecoration(color: kPrimaryBg, borderRadius: BorderRadius.circular(99)),
                      child: Text(
                        document.amount == 0 ? 'FREE' : '₱ ${document.amount.toStringAsFixed(2)}',
      ...
      child: _FormCard(
        ...
        child: fields.isEmpty
          ...
          child: Column(
            children: [
              const _InfoBanner(
                message: 'These fields will be pre-filled by the barangay staff.',
              ),
              ...fields.map((field) {
          ...
          Expanded(
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                disabledBackgroundColor: (isLast ? kSuccess : kPrimary).withOpacity(0.5),
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: kBorder),
        boxShadow: [
          BoxShadow(color: kPrimary.withOpacity(0.05), blurRadius: 12, offset: const Offset(0, 4)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: kPrimaryBg, borderRadius: BorderRadius.circular(7)),
          ...
          const SizedBox(height: 8),
          Text(title, style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: kInk, height: 1.1)),
          const SizedBox(height: 4),
          Text(subtitle, style: const TextStyle(fontSize: 12, color: kInk2, height: 1.4)),
        ...
        children: [
          ...
          TextFormField(
            ...
            validator: widget.required
                ? (v) => (v == null || v.trim().isEmpty) ? '${widget.label} is required' : null
                : null,
            decoration: InputDecoration(
              hintText: widget.hint,
              hintStyle: TextStyle(color: kInk3, fontSize: 13),
              prefixIcon: Icon(widget.icon, size: 17, color: _isFocused ? kPrimary : kInk3),
              filled: true,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text(label, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: kInk2)),
              const Text(' *', style: TextStyle(color: kDanger, fontSize: 12)),
            ],
          ),
          const SizedBox(height: 6),
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: kInk3, fontSize: 13),
              prefixIcon: const Icon(Icons.calendar_today_rounded, size: 16, color: kInk3),
              suffixIcon: const Icon(Icons.keyboard_arrow_down_rounded, color: kInk3, size: 20),
              filled: true,
              fillColor: kSurface,
              contentPadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 13),
              border: OutlineInputBorder(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 8),
          Expanded(
            child: Text(message, style: TextStyle(fontSize: 12, color: color, height: 1.4)),
          ),
        ],
      ),
    );
      ...
      child: const Column(
        children: [
          ...
          Text(
            ...
            style: TextStyle(color: kInk2, fontSize: 13, fontWeight: FontWeight.w600),
          ),
        ],
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Expanded(flex: 2, child: Text(label, style: const TextStyle(fontSize: 12, color: kInk2))),
          const SizedBox(width: 12),
          Expanded(
            flex: 3,
            child: Text(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.check_rounded, color: kSuccess, size: 46),
                ),
                const SizedBox(height: 24),
                const Text(
                  'Request Submitted!',
                  style: TextStyle(fontSize: 24, fontWeight: FontWeight.w800, color: kInk),
                ),
                const SizedBox(height: 8),
                Text(
                  'Your $documentTitle request has been received and is now being processed.',
                  textAlign: TextAlign.center,
                  style: const TextStyle(color: kInk2, fontSize: 13, height: 1.5),
                ),
                const SizedBox(height: 24),
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: kBorder),
                    boxShadow: [
                      BoxShadow(color: kPrimary.withOpacity(0.08), blurRadius: 12, offset: const Offset(0, 4)),
                    ],
                  ),
                  child: Column(
                    children: [
                      const Text(
                        'Tracking ID',
                        style: TextStyle(fontSize: 11, color: kInk2, fontWeight: FontWeight.w600),
                      ),
                      const SizedBox(height: 4),
                      Text(
                        trackingId,
