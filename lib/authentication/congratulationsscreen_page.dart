                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 15, color: Colors.white.withOpacity(0.9), height: 1.5, fontWeight: FontWeight.w500),
                      ),
                    ),
                  ],
                ),
              ...
              child: Column(
                children: [
                  ...
                  const Text(
                    ...
                    textAlign: TextAlign.center,
                    style: TextStyle(fontSize: 13, color: AppColors.textGrey, height: 1.6, fontWeight: FontWeight.w500),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () => Navigator.pushAndRemoveUntil(context, instantRoute(const LoginPage()), (r) => false),
                      ...
                      child: const Text('Back to Sign In', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
                    ),
                  ),
                ],
              ),
